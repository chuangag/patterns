...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Nov 9 16:35:10 2016
...
SOURCES       = Brute.cpp \
		...
		main.cpp \
		Point.cpp \
		PointPlotter.cpp moc_PointPlotter.cpp
OBJECTS       = Brute.o \
		Fast.o \
		main.o \
		Point.o \
...
all: Makefile $(TARGET) Brute Fast
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/patterns1.0.0/ && $(COPY_FILE) --parents Brute.h Fast.h Point.h PointPlotter.h .tmp/patterns1.0.0/ && $(COPY_FILE) --parents Brute.cpp Fast.cpp main.cpp Point.cpp PointPlotter.cpp .tmp/patterns1.0.0/ && (cd `dirname .tmp/patterns1.0.0` && $(TAR) patterns1.0.0.tar patterns1.0.0 && $(COMPRESS) patterns1.0.0.tar) && $(MOVE) `dirname .tmp/patterns1.0.0`/patterns1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/patterns1.0.0
...
compiler_moc_header_make_all: moc_PointPlotter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_PointPlotter.cpp
moc_PointPlotter.cpp: Brute.h \
		Point.h \
		Fast.h \
		PointPlotter.h
	/usr/local/software/qt-4.8.6/bin/moc $(DEFINES) $(INCPATH) PointPlotter.h -o moc_PointPlotter.cpp
...
Brute.o: Brute.cpp Brute.h \
		Point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Brute.o Brute.cpp

Fast.o: Fast.cpp Fast.h \
		Point.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Fast.o Fast.cpp

main.o: main.cpp Brute.h \
		Point.h \
		Fast.h \
		PointPlotter.h
...
PointPlotter.o: PointPlotter.cpp PointPlotter.h \
		Brute.h \
		Point.h \
		Fast.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o PointPlotter.o PointPlotter.cpp

moc_PointPlotter.o: moc_PointPlotter.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_PointPlotter.o moc_PointPlotter.cpp
	
Brute: Brute_test.cpp Brute.o Point.o
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Brute_test.o Brute_test.cpp
	#g++ -c -o testBrute.o testBrute.cpp
	$(LINK) -o Brute Brute_test.o Brute.o Point.o $(LIBS)

Fast: Fast_test.cpp Fast.o Point.o
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Fast_test.o Fast_test.cpp
	#g++ -c -o testFast.o testFast.cpp
	$(LINK) -o Fast Fast_test.o Fast.o Point.o $(LIBS)
